...
export const AssetsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiAssetsIdDelete: async (
      id: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists('apiAssetsIdDelete', 'id', id)
      const localVarPath = `/api/assets/{id}`.replace(
        `{${'id'}}`,
  ...
  return {
    ...
    async apiAssetsGet(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ApiAssetsGet200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiAssetsGet(
        page,
        pageSize,
        assetTypeId,
        options
      ...
      const localVarOperationServerBasePath =
        operationServerMap['AssetsApi.apiAssetsGet']?.[
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiAssetsIdDelete(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AssetsApi.apiAssetsIdDelete']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AssetsApi.apiAssetsIdGet']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiAssetsIdPut(
        id,
        apiAssetsIdPutRequest,
        options
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AssetsApi.apiAssetsIdPut']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AssetsApi.apiAssetsPost']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export const AssetsApiFactory = function (
  ...
  return {
     ...
     */
    apiAssetsGet(
      requestParameters: AssetsApiApiAssetsGetRequest = {},
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiAssetsGet200Response> {
      return localVarFp
        .apiAssetsGet(
     ...
     */
    apiAssetsIdDelete(
      requestParameters: AssetsApiApiAssetsIdDeleteRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiAssetTypesIdDelete200Response> {
      return localVarFp
        .apiAssetsIdDelete(requestParameters.id, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
     ...
     */
    apiAssetsIdPut(
      requestParameters: AssetsApiApiAssetsIdPutRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiAssetsPost201Response> {
      return localVarFp
        .apiAssetsIdPut(
          requestParameters.id,
          requestParameters.apiAssetsIdPutRequest,
          options
        )
        .then(request => request(axios, basePath))
    },
     ...
     */
    apiAssetsPost(
      requestParameters: AssetsApiApiAssetsPostRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ApiAssetsPost201Response> {
      return localVarFp
        .apiAssetsPost(requestParameters.apiAssetsPostRequest, options)
        .then(request => request(axios, basePath))
    },
  }
}
